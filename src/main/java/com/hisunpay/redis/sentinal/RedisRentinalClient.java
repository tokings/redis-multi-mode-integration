 ...
 *
 */
public class RedisRentinalClient {
	public RedisRentinalClient(String masterName, String servers, int maxTotal, int maxIdle, int minIdle,
			long maxWaitMillis) {
		RedisRentinalServer.getInstance().start(masterName, servers, maxTotal, maxIdle, minIdle, maxWaitMillis);
	}

	public void close() {
		RedisRentinalServer.getInstance().stop();
	}
	
	public Jedis getResurce() {
		return RedisRentinalServer.getInstance().getResource();
	}

	public void returnResource(Jedis jedis) {
		RedisRentinalServer.getInstance().returnResource(jedis);
	}
	...
	public boolean exists(String key)
	{
		...
		try {
			jedis = RedisRentinalServer.getInstance().getResource();		
